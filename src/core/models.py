...
class Order:
    ...
    position_ticket: Optional[int] = None  # For partial closes: links to existing position
...
class StrategySignal:
    """A signal generated by a trading strategy for backtesting/live execution."""
    symbol: str
    ...
    reason: str
    strategy_name: str = ""
    trail_trigger: float = 0.0   # activate trailing after this profit distance
    trail_distance: float = 0.0  # trail SL by this distance from peak price
